class STTrialHandling {
    ...
    saveTrialData() {
        this.dataRecorder.addDataRow([this.serialNumber,Config.run ,Config.input_device ,Config.isTestSet, this.blockNumber, this.trialNumber, this.trialId, this.trialCategory, this.trialGetsRepeated, this.clickCategory, this.repetitions, this.username, this.shape, this.intDevice,
