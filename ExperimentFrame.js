...
displayFinishWindow() {
    ...
    */
    displayTextValues() {
        ...
        const trialsToBreakElement = document.getElementById("breakCount");
        trialsToBreakElement.textContent = this.getRemainingTrials();
    
     
        const finishedTrialsElement = document.getElementById("finishedTrialsLabel");
        finishedTrialsElement.innerHTML = `Finished Trials: ${this.totalFinishedTrialsAmountWithoutReAddition} / ${this.getTotalTrialsStartAmount().toString()}`;
